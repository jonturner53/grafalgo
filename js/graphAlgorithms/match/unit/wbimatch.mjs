...
g = randomBigraph(7, 7, 3); g.randomWeights(randomInteger, 1, 9);
tester.addTest('small random', g);
g = randomBigraph(100, 100, 5); g.randomWeights(randomInteger, 1, 99);
tester.addTest('medium random', g);
g = randomBigraph(400, 400, 20); g.randomWeights(randomInteger, 1, 99);
