...
try {
	...
	[elist, ts, stats] = mst_chetar(g, trace);
	if (trace) console.log(ts);
	if (showStats) console.log(stats);
	assert(g.elist2string(elist),
				  '[(a,d,2) (b,d,1) (c,d,1) (e,f,1) (f,g,2) (c,h,6) ' +
				  '(b,i,1) (i,j,1) (c,f,2)]', 'a6');
	...
	if (showStats) console.log(stats);
	assert(g.elist2string(elist),
				'[(a,d,2) (a,b,3) (c,d,1) (e,f,1) (g,h,1) (f,g,2)]', 'a7'); 
	assert(mst_verify(g, elist), 'ok', 'a7');
