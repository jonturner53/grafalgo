...
/** Compute lower bound on weight of an optimal set cover based on the
 *  primal-dual algorithm of Bar-Yehuda and Even.
 ...
 *  @return a computed lower bound
 */
export default function setCoverLabelBound(g, weight) {
