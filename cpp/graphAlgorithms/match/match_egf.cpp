 ...
 */
match_egf::match_egf(Graph& g1, List_g<edge>& match) : g(&g1) {
	vertex u, v; edge e;
 ...
 */
vertex match_egf::nca(vertex u, vertex v) {
 ...
 */
edge match_egf::path(vertex a, vertex b) {
