 ...
 */
pmatch_t::pmatch_t(Graph& g1, int* priority, List_g<edge>& match)
		: g(&g1), prty(priority) {
 ...
 */
vertex pmatch_t::nca(vertex u, vertex v) {
 ...
 */
edge pmatch_t::path(vertex a, vertex b) {
 ...
 */
vertex pmatch_t::root(vertex vp) {
	vertex rv = vp;
