 ...
 */
vsetMatch::vsetMatch(Graph& g1, Dlist& vset1, Glist<edge>& match) {
	g = &g1; vset = &vset1;
...
vsetMatch::~vsetMatch() { delete [] pEdge; delete [] mEdge; }
