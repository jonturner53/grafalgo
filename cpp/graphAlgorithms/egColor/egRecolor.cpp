 ...
 */
egRecolor::egRecolor(GroupGraph& g, int edgeColors[]) : egLayers(g,edgeColors) {
 ...
 */
void egRecolor::recolorGroup(int grp) {
 ...
 */
bool egRecolor::foundPath(edge e, int i, int j) {
	vertex u = gp->input(e); vertex v = gp->output(e);
	// check for path
