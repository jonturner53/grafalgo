...
public:
	...
	testcase(Ddheap<int>& dh, string m, int a1, int a2, int a3, 
		 int rv, string exp) {
...
public:
	...
	testcase2(Ddheap<string>& dh, string m, int a1, int a2, int a3,
...
/**
 *  Unit test for Ddheap data structure.
 */
int main() { runTests1(); }
