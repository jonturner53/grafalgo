...
void basicTests() {
	...
	Utest::assertEqual(map1.toString(), "{1234:1}",
	...
	Utest::assertEqual(map1.toString(), "{1234:1 2345:2 3456:3}",
		"mismatch after adding third item");
	cout << "writing 3 idMap: " << map1 << endl;

	map1.dropPair(2345);
	Utest::assertEqual(map1.toString(), "{1234:1 3456:3}",
		"mismatch after releasing second id");

	map1.addPair(4567);
	Utest::assertEqual(map1.toString(), "{1234:1 3456:3 4567:4}",
